...
import DashBoardComponent from '../History_Component/DashBoardComponent'
import { DateRangePicker } from 'react-date-range';
import DateRangeIcon from '@material-ui/icons/DateRange';
import Moment from 'moment'
import { domain } from '../../../static/api_request_urls'

function ParentHistoryComponent(){
    ...
    useEffect(() => {
        axios.get(`${domain}api/parent-history/`, {
            headers: {
    ...
    const handleMonth = (month) => {
        axios.post(`${domain}api/parent-history/`, {
            month: month
        }, {
            headers: {
                'Authorization': 'Token ' + token
    ...
    const handleFilterDate = () => {
        ...
        axios.post(`${domain}api/parent-filter-history/`, {
...
export default ParentHistoryComponent