...
// Url
import { activate_child_request_url } from '../../../static/api_request_urls'
...
function ActivatedComponent(){
    ...
    React.useEffect(() => {
        ...
        fetch(activate_child_request_url, activation_request)
        .then( response => {
            if(response.ok){
    ...
    return (
        <React.Fragment>
            ...
            <img className="bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto" width="600" height="500" src={activation_success} alt="activation_success"></img>
                <h3 className="text-muted text-center">You successfully accepted your parent invitation!</h3>
