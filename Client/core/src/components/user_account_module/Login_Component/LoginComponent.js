                ...
                <Container fluid className="h-100">
                    <div className="row featurette">
                        <div className={margin_login}>
                            <h3 className="featurette-heading font-weight-bold">Welcome to KMLNGMLKS Corp.</h3>
                        ...
                        <div className="col-md-7 order-md-1">
                            <img className="bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto" width="600" height="500" src={workforce} alt="workforce"></img>
                        </div>
                    </div>
                </Container>
            </Container>
